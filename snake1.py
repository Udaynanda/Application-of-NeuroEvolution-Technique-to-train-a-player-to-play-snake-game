...
class Snake:
    ...
    def draw(self, board: Board) -> None:
        for i, position in enumerate(self.body[:]):
            board.draw_block(position, green)
...
def run(config_path, population):
    ...
    winner = population.run(fitness, 1000)
    print('\nBest genome:\n{!s}'.format(winner))
    node_names = {-1:'I1', -2: 'I2', -3 : 'I3', -4 : 'I4' , -5 : 'I5', -6 : 'I6', -7 :'I7', -8 : 'I8',  0:'left', 1 : 'right'}
